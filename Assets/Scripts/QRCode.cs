    ...
    public class QRCode : MonoBehaviour
    {
        ...
        void UpdatePropertiesDisplay()
        {
            ...
            if (qrCode != null && lastTimeStamp != qrCode.SystemRelativeLastDetectedTime.Ticks)
            {
                ...
                GameObject axes = GameObject.FindWithTag("QROrigin");
                if (!(axes is null))
                {
                    axes.transform.localPosition = new Vector3(PhysicalSize / 2.0f, PhysicalSize / 2.0f, 0.0f);
                    axes.transform.localScale = new Vector3(PhysicalSize, PhysicalSize, 1.0f);
                }
        ...
        void Update()
        {
            ...
            {
                axes.transform.localPosition = new Vector3(PhysicalSize / 2.0f, PhysicalSize / 2.0f, 0.0f);
                axes.transform.localScale = new Vector3(PhysicalSize, PhysicalSize, 0.005f);
            }
        }
